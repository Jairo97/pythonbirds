...
class Motor:
    ...
    def frear(self):
        self.velocidade -=2
        self.velocidade = max(0,self.velocidade) #Moodo simplificado sem a utilização de if/else
...
class Direcao:
    ...
    def girar_a_direita(self):
        direcao = {'Norte': 'Leste', 'Leste': 'Sul', 'Sul': 'Oeste', 'Oeste': 'Norte'}
        self.valor = direcao[self.valor]
    def girar_a_esquerda(self):
        direcao = {'Norte': 'Oeste','Oeste': 'Sul','Sul': 'Leste', 'Leste': 'Norte'}
        self.valor = direcao[self.valor]
class Carro:
